...
def RunStan(df_flatfile, df_cellinfo, df_celldist, stan_model_fname, 
    ...
    if pystan_ver == 2:
        ...
        stan_posterior = np.concatenate((stan_posterior, stan_fit['c_2e']),   axis=1)
        ...
        stan_posterior = np.concatenate((stan_posterior, stan_fit['c_2e'].T),   axis=1)
    ...
    del col_names_dc_1e, col_names_dc_1as, col_names_dc_1bs, col_names_c_2e, col_names_c_3s, col_names_dB
    ...
    #---  ---  ---  ---  ---  ---  ---  ---
    #mean prediction
    y_mu  = (coeff_0_mu + coeff_1e_mu + coeff_1as_mu + coeff_1bs_mu + coeff_2e_mu*x_2 + coeff_3s_mu*x_3[sta_inv] + cells_LcA_mu)
