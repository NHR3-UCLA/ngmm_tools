...
# out_dir_sub    <- 'INLA_NGAWest2CA_uncorr_cells_fine_nexp'
# out_dir_sub    <- 'INLA_NGAWest2CA_uncorr_cells_medium_nexp'
# out_dir_sub    <- 'INLA_NGAWest2CA_uncorr_cells_coarse_nexp'
