...
# out_dir_sub    <- 'INLA_NGAWest2CANorth_uncorr_cells'
out_dir_sub    <- 'INLA_NGAWest2CANorth_uncorr_cells_fine'
# out_dir_sub    <- 'INLA_NGAWest2CANorth_uncorr_cells_medium'
# out_dir_sub    <- 'INLA_NGAWest2CANorth_uncorr_cells_coarse'
