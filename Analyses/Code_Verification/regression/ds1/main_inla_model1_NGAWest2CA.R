...
# out_dir_sub    <- 'INLA_NGAWest2CA'
#matern kernel function (nu=2)
# out_dir_sub    <- 'INLA_NGAWest2CA_fine'
# out_dir_sub    <- 'INLA_NGAWest2CA_medium'
# out_dir_sub    <- 'INLA_NGAWest2CA_coarse'
# out_dir_sub    <- 'INLA_NGAWest2CA_medium_full'
#exponential kernel function
# out_dir_sub    <- 'INLA_NGAWest2CA_fine_nexp'
# out_dir_sub    <- 'INLA_NGAWest2CA_medium_nexp'
# out_dir_sub    <- 'INLA_NGAWest2CA_coarse_nexp'
...
flag_gp_approx <- FALSE # TRUE or FALSE
