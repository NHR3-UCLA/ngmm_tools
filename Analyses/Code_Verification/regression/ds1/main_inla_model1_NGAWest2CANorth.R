...
# out_dir_sub    <- 'INLA_NGAWest2CANorth'
#matern kernel function (nu=2)
# out_dir_sub    <- 'INLA_NGAWest2CANorth_fine'
# out_dir_sub    <- 'INLA_NGAWest2CANorth_medium'
# out_dir_sub    <- 'INLA_NGAWest2CANorth_coarse'
#exponential kernel function
# out_dir_sub    <- 'INLA_NGAWest2CANorth_fine_nexp'
# out_dir_sub    <- 'INLA_NGAWest2CANorth_medium_nexp'
# out_dir_sub    <- 'INLA_NGAWest2CANorth_coarse_nexp'
...
for (d_id in ds_id){
  ...
  df_flatfile <- subset(df_flatfile, dsid==0 & sreg==1)
