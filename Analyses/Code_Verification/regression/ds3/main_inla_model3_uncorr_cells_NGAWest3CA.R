...
# out_dir_sub    <- 'INLA_NGAWest3CA_uncorr_cells_fine_nerg'
# out_dir_sub    <- 'INLA_NGAWest3CA_uncorr_cells_medium_nerg'
# out_dir_sub    <- 'INLA_NGAWest3CA_uncorr_cells_coarse_nerg'
